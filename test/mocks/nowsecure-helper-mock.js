...
const MOCK_APPLICATION_IOS_PACKAGE = 'ios.mock';
const MOCK_APPLICATION_ANDROID_PACKAGE = 'android.mock';
const MOCK_GROUP_ID = 'e1a73363-47c2-45e2-b8b1-8a188f9a773e';
...
const MOCK_ERROR_ASSESSMENT_RESULT = {
  name: 'NotFoundError',
  message: 'Assessment not found within user scope',
  status: 404

};

module.exports = { MOCK_ACCESS_TOKEN, MOCK_APPLICATION_ANDROID_PACKAGE, MOCK_APPLICATION_IOS_PACKAGE, MOCK_ASSESSMENT, MOCK_GROUP_ID, MOCK_IOS_TASK, MOCK_IOS_ASSESSMENT_REPORT_PER_TASK, MOCK_ANDROID_TASK, MOCK_IOS_ASSESSMENT_RESULT, MOCK_ERROR_ASSESSMENT_RESULT };
