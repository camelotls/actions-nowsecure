  ...
  describe('Nowsecure REST calls successful cases', () => {
    it('An assessment can be retrieved for iOS', async () => {
      nock(`https://${config.NOWSECURE.URI}`)
        .get(`/${config.NOWSECURE.ENDPOINTS.APPLICATION}/ios/${mock.MOCK_APPLICATION_IOS_PACKAGE}/${config.NOWSECURE.ENDPOINTS.ASSESSMENT}/`)
    ...
    it('An assessment can be retrieved for Android', async () => {
      nock(`https://${config.NOWSECURE.URI}`)
        .get(`/${config.NOWSECURE.ENDPOINTS.APPLICATION}/android/${mock.MOCK_APPLICATION_ANDROID_PACKAGE}/${config.NOWSECURE.ENDPOINTS.ASSESSMENT}/`)
