...
const retrieveAssessment = async function retrieveAssessment (platform) {
  ...
  const nowsecureEndpoint = `/${config.NOWSECURE.ENDPOINTS.APPLICATION}/${platform}/${appPackage}/${config.NOWSECURE.ENDPOINTS.ASSESSMENT}/?group=${config.NOWSECURE.ENDPOINTS.GROUP_ID}`;
